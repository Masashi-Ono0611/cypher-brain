...
EXPECTED=$(printf '%s\n' init keygen sss-split sss-combine wallet snapshot restore verify bagit-export push push-status pull publish-latest estimate recovery-kit schedule doctor ledger audit witness | sort | tr '\n' ' ')
[ "$LISTED" = "$EXPECTED" ] \
